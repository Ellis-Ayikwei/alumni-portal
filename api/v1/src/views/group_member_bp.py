...
def get_user_group_memberships(user_id):
    ...
    for membership in group_memberships:
        ...
        membership_info['user_info'] = membership.user_info.to_dict() if membership.user_info else None
...
def get_all_group_members():
    ...
    for member in group_members:
        ...
        member_dict['user_info'] = member.user_info.to_dict() if member.user_info else None
