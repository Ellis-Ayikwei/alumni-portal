...
app_views_info_logger = setup_logger('app_views', 'app_views_info.log', level=logging.INFO)
app_views_debug_logger = setup_logger('app_views', 'app_views_debug.log', level=logging.DEBUG)
app_views_error_logger = setup_logger('app_views', 'app_views_debug.log', level=logging.ERROR)
app_auth_info_logger = setup_logger('app_auth', 'app_auth_info.log', level=logging.INFO)
app_auth_error_logger = setup_logger('app_auth', 'app_auth_error.log', level=logging.ERROR)
